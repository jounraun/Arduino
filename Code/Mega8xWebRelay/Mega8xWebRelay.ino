...
byte ip[] = {192, 168, 1, 123}; //Manual setup only

byte gateway[] = {192, 168, 1, 20 }; //Manual setup only

byte subnet[] = {255, 255, 255, 0 }; //Manual setup only

byte mac[] = {0xDE, 0xA1, 0xB2, 0xEF, 0xFE, 0xED };
...
int retainOutputStatus[16] = {0,0,0,0,0,0,0,0};//1-retain the last status. 0-will be off after power cut.
