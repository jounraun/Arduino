...
//          Serial.println(readString); //print to serial monitor for debuging
          ...
          client.println(F("<link rel='stylesheet' type='text/css' href='http://acerlink.ddns.net:2344/Enc4xRelay.css'/>"));
          client.println(F("<TITLE>Enc4xRelay</TITLE>"));
          client.println(F("</HEAD>"));
          client.println(F("<BODY>"));
          client.println(F("<H1>Enc4xRelay</H1>"));
          client.println(F("<hr/>"));
          client.println(F("<br>"));
