...
// **** ETHERNET SETTING ****
byte mac[] = { 0x54, 0x24, 0x21, 0x70, 0x10, 0x21 };                                       
...
//          Serial.println(readString); //print to serial monitor for debuging
          ...
          client.println(F("<link rel='stylesheet' type='text/css' href='http://acerlink.ddns.net:2344/Web4xRelay.css'/>"));
          client.println(F("<TITLE>Web4xRelay</TITLE>"));
          client.println(F("</HEAD>"));
          client.println(F("<BODY>"));
          client.println(F("<H1>Web4xRelay</H1>"));
          client.println(F("<hr/>"));
          client.println(F("<br>"));
